...
$this_script = "scores.php";
	...
	$query = "SELECT DISTINCT(FestivalYear) FROM Festivals ORDER BY FestivalYear ASC";
...
while ($row = mysql_fetch_array($result)) {
	...
	echo "<p><h2>Illinois Marching Online Scores Library ($queryyear) </h2><p>";
	echo "<h3>Years: ";	
