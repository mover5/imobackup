...
if (isset($_POST['b'])) {
	$b = $_POST['b'];
	$query = "DELETE FROM Bands WHERE BandID='$b'";
	mysql_query($query);
	$message = "Deleted band successfully";
}
	...
	<div id="contentwrapper">
		<div id="contentcolumn">
			<div class="innertube">
				...
				?>
				<form action="delete_band.php" method="post">
					<select name="b" id="b">
						<?php
							while ($row = mysql_fetch_array($result)) {
								$b = $row['BandID'];
								$school = $row['School'];
								echo "<option value=".$b.">".$school."</option>";
							}
						?>
					</select>
					<input type="submit" value="Delete Band" name="submit" />
				</form>
			</div>
		</div>
	</div>
