	...
	<div id="contentwrapper">
		<div id="contentcolumn">
			<div class="innertube">
				...
				<table border=1><tr><td><b>School</b></td><td><b>Director</b></td><td><b>Email</b></td></tr>
				<?php
				$query = "SELECT d.Director, School, Email FROM BandDirectorEmail d, Bands b WHERE d.BandID = b.BandID ORDER BY School";
