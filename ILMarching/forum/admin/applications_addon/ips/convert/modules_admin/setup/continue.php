...
class admin_convert_setup_continue extends ipsCommand
{
    ...
    */
	...
	{
		$this->registry->output->html .= $this->html->convertHeader('Continue Conversion');
		...
		if ( !$options )
		{
			$this->registry->output->html .= $this->html->convertError('You have no conversions to continue. Did you want to start a <a href="'.$this->settings['base_url'] . 'app=convert&module=setup">New Conversion?</a>');
		}
		else 
		{
