	...
	class admin_convert_board_vbulletin extends ipsCommand
	{
	    ...
	    */
	    public function doExecute( ipsRegistry $registry )
		{
			...
			$this->lib->sendHeader( 'vBulletin 4.x &rarr; IP.Board Converter' );
	    ...
	    */
		...
		private function convert_profile_friends()
		{
			...
			$main = array(	'select' 	=> '*',
							'from' 		=> 'userlist',
							'where'		=> "type='buddy'",
							'order'		=> 'userid ASC, relationid ASC, type ASC',
						);
