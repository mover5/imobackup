 ...
 * SMF LEGACY (SMF 1.1)
 * Last Update: $Date: 2013-08-07 17:45:25 -0400 (Wed, 07 Aug 2013) $
 ...
 *
 * @deprecated	SMF 2.0 is now considered Final - this file will be subject to removal from the package or not maintained. Please upgrade to SMF 2.0.
 */
	...
	*/
	...
	private function convert_attachments()
	{
		...
		while ( $row = ipsRegistry::DB('hb')->fetch($this->lib->queryRes) )
		{
			...
			// Date
			$post = ipsRegistry::DB('hb')->buildAndFetch(array('select' => 'ID_MEMBER, posterTime, ID_TOPIC', 'from' => $this->prefixFull . 'messages', 'where' => 'ID_MSG='.$row['ID_MSG']));
