 ...
 * SMF
 * Last Update: $Date: 2013-07-15 09:35:52 -0400 (Mon, 15 Jul 2013) $
	    ...
	    */
		...
		private function convert_cal_events()
		{
			...
			while ( $row = ipsRegistry::DB('hb')->fetch($this->lib->queryRes) )
			{
				...
				{
					$this->lib->logError($row['id_event'], 'Could not find calander topic.');
				}
				...
				$save = array(
					...
					'event_all_day'		=> ( $row['start_date'] == $row['end_date'] ) ? 1 : 0,
					);
