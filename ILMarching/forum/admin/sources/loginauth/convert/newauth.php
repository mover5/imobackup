 ...
 * Application Files
 * Login functions
 * Last Updated: $Date: 2013-12-30 22:36:23 -0500 (Mon, 30 Dec 2013) $
 *
...
class converters
{
	...
	private function phpbb($username, $email, $password)
	{
		...
		if ( ! $success )
		{
			$success = ( $this->parent->hashCryptPrivate( $single_md5_hash, $hash, $itoa64 ) === $hash ? true : false );
		}
	...
	{
		if ($this->parent->_memberData['conv_password'] == md5(md5(str_replace('&#39;', "'", html_entity_decode($password))) . $this->parent->_memberData['misc']))
		{
			return true;
		}
		else
