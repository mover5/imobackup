 ...
 * Last Updated: $LastChangedDate: 2013-02-19 15:55:32 -0500 (Tue, 19 Feb 2013) $
 * </pre>
 *
...
class reportNotifications
{
	...
	public function sendReplyNotifications( $postContent )
	{
		...
		foreach( $this->my_data as $user )
		{
			...
			$notifyLibrary->setNotificationText( str_replace( '#member_name#', $user['members_display_name'], IPSText::getTextClass('email')->message ) );
