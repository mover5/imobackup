...
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(1, 'Twitter', 'twitter', 1, 1, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(2, 'Facebook', 'facebook', 1, 2, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(3, 'Google Plus One', 'googleplusone', 1, 3, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(4, 'Digg', 'digg', 1, 4, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(5, 'Del.icio.us', 'delicious', 1, 6, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(6, 'Reddit', 'reddit', 1, 7, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(7, 'StumbleUpon', 'stumble', 1, 8, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(8, 'Email', 'email', 1, 9, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(10, 'Print', 'print', 1, 10, 0, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(11, 'Download', 'download', 1, 11, 0, '*');";
