		...
		new Ajax.Request( _url,
						  {
							...
							onSuccess: function (t)
							{
								...
								if ( json['change_data_content'] )
								{
									...
									{
										content = '<div class="acp-box"><h3>'+ _text + ': ' + json['change_data_title'] + '.css</h3><div style="padding:4px;line-height:125%;overflow: auto;max-height: 535px;"><pre>' + json['change_data_content'] + '</pre></div>' + _qb + "</div>";
									}
									else
									{
										content = '<div class="acp-box"><h3>'+ _text + ': ' + json['change_data_group'] + ' &gt; ' + json['change_data_title'] + '</h3><div style="padding:4px;line-height:125%;overflow: auto;max-height: 535px;"><pre>' + json['change_data_content'] + '</pre></div>' + _qb + "</div>";
									}
