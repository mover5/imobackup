...
_tt.prototype.tabbedEditor = {
	...
	_popUpShow: function( event )
	{
		...
		$( 'tbe_editor_textarea_' + _id ).observe('change', acp.tabbedEditor._keyDownCheck.bindAsEventListener( event, event.id.replace( /^_p_/, '' ) ) );
	},
	...
	_createTab: function( id, title, content )
	{
		...
		$( 'tbe_editor_textarea_' + id ).observe('change', acp.tabbedEditor._keyDownCheck.bindAsEventListener( this, id ) );
