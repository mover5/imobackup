 ...
 */
	...
	class admin_convert_gallery_photopost7 extends ipsCommand
	{
		/**
	    ...
	    */
	    public function doExecute( ipsRegistry $registry )
		{
			...
			$this->lib->sendHeader( 'Photopost 7 &rarr; IP.Gallery Converter' );
	    ...
	    */
		...
		private function convert_gallery_categories()
		{
			...
			while ( $row = ipsRegistry::DB('hb')->fetch($this->lib->queryRes) )
			{
				$row['parent'] = $row['parent'] == -1 ? 0 : $row['parent'];

				$save = array(
					'category_parent_id'	=> ( $row['parent'] ? $row['parent'] : 0 ),
