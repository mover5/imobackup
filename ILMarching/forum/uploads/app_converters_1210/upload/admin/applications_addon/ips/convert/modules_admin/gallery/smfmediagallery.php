	    ...
	    */
		...
		private function convert_gallery_albums()
		{
			...
			while ( $row = ipsRegistry::DB('hb')->fetch($this->lib->queryRes) )
			{
					...
					$this->lib->convertAlbum( $row['id_album'], $save, false, true );
			}
		...
		private function convert_gallery_comments()
		{
			...
			{
				$save = array(
					'comment_author_id'		=> $row['id_member'],
					'comment_img_id'		=> $row['id_media'],
					'comment_text'		=> $this->fixPostData($row['message']),
					'comment_post_date'		=> $row['posted_on'],
					'comment_edit_time'		=> $row['last_edited'],
