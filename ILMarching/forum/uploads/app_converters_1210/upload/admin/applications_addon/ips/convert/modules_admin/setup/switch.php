...
class admin_convert_setup_switch extends ipsCommand
{
    ...
    */
    public function doExecute( ipsRegistry $registry )
	{
		...
		if (!$app)
		{
			$this->registry->output->html .= $this->html->convertError('<strong>An unexpected error occurred, could not locate conversion ID. Please try again.</strong><br /><a href="'.$this->settings['base_url'] . 'app=convert&module=setup">Go Back</a>');
			$this->sendOutput();
			exit;
		}
