...
class admin_convert_setup_manage extends ipsCommand
{
    ...
    */
	private function show()
	{
		...
		if ( !$apps )
		{
			$this->registry->output->html .= $this->html->convertError('You have no conversions to manage. Did you want to start a <a href="'.$this->settings['base_url'] . 'app=convert&module=setup">New Conversion?</a>');
		}
		else 
		{
