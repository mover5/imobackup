	...
	private function convert_ccs_articles()
	{
		...
		while ( $row = ipsRegistry::DB('hb')->fetch($this->lib->queryRes) )
		{
			...
			$save = array( 	'member_id'				=> 	$row['userid'],
							...
							'record_topicid'		=>	$row['threadid'], // http://community.invisionpower.com/topic/374655-vb-cms-to-ipcontent-linked-discussions-are-not-converted/
						//	'field_14' /* teaser */	=>	$row['previewtext'], # @todo test this
