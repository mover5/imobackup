 ...
 * @deprecated	Replaced by modules_admin/nexus/vbulletin_subs.php
 * 
 * @todo		Remove this.
 */
			...
			while ( $row = ipsRegistry::DB('hb')->fetch($this->lib->queryRes) )
			{
				...
				foreach ($costs as $cost)
				{
					...
					$save = array(
						...
						'sub_unit'			=> IPSText::mbstrtolower($cost['units']),
						'sub_cost'			=> $cost['cost'][IPSText::mbstrtolower($default_currency['subcurrency_code'])],
						);
