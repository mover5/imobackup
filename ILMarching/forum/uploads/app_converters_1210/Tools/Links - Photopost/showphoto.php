 ...
 */
	...
	if (!is_numeric(ipsRegistry::$request['photo']))
	{
		// Boink to index
	...
	$row = $DB->buildAndFetch( array( 'select' => 'ipb_id', 'from' => 'conv_link', 'where' => "foreign_id='".ipsRegistry::$request['photo']."' AND type='gallery_images' AND app='".$app['app_id']."'" ) );
