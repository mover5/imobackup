...
#RewriteRule ^[^/]+/[^/]-[^/]+\.html#post([0-9]+) http://www.site.com/forum/showpost.php?p=$1 [L,R=301]
...
$qs = explode('-', str_replace( '/showthread.php/', '', $_SERVER['QUERY_STRING'] ? $_SERVER['QUERY_STRING'] : $_SERVER['REQUEST_URI'] ) );
$qs = str_replace('t=', '', $qs);
ipsRegistry::$request['t'] = $qs[0];
