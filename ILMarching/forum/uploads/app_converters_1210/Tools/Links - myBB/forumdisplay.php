 ...
 */
	...
	if (!is_numeric(ipsRegistry::$request['fid']))
	{
		// Boink to index
	...
	$row = $DB->buildAndFetch( array( 'select' => 'ipb_id', 'from' => 'conv_link', 'where' => "foreign_id='".intval(ipsRegistry::$request['fid'])."' AND type='forums' AND app='".$app['app_id']."'" ) );
