...
//-----------------------------------------
$row = $DB->buildAndFetch( array( 'select' => 'ipb_id', 'from' => 'conv_link', 'where' => "foreign_id='".$fbbglobals['uid']."' AND type='members' AND app='".$app['app_id']."'" ) );
