...
{
$count_24d7bc87e489c72580fce29a8d5888c3 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_24d7bc87e489c72580fce29a8d5888c3]['data'] = $data;
}
...
{
$count_dd70297614847f70634705fe4a191125 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_dd70297614847f70634705fe4a191125]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_dd70297614847f70634705fe4a191125]['form'] = $form;
}
...
{
$count_e462d800a74de96bef7e1691b2445edd = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_e462d800a74de96bef7e1691b2445edd]['data'] = $data;
}
...
{
$count_15a8b226c19d11aca16f5cb1342c4ffe = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_15a8b226c19d11aca16f5cb1342c4ffe]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__59dccaf6e9788a319b79b4a41dc2a009($posts)."") : ("")) . "
<p class='submit'>
...
function __f__59dccaf6e9788a319b79b4a41dc2a009($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_455f021a53a68b2734633648c242d9b7 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_455f021a53a68b2734633648c242d9b7]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_455f021a53a68b2734633648c242d9b7]['type'] = $type;
$this->functionData['uploadForm'][$count_455f021a53a68b2734633648c242d9b7]['stats'] = $stats;
$this->functionData['uploadForm'][$count_455f021a53a68b2734633648c242d9b7]['id'] = $id;
$this->functionData['uploadForm'][$count_455f021a53a68b2734633648c242d9b7]['forum_id'] = $forum_id;
}
