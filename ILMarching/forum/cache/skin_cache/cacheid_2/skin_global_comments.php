...
{
$count_ec67aa252979f4507126e64b7415a841 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_ec67aa252979f4507126e64b7415a841]['r'] = $r;
$this->functionData['commentHidden'][$count_ec67aa252979f4507126e64b7415a841]['parent'] = $parent;
$this->functionData['commentHidden'][$count_ec67aa252979f4507126e64b7415a841]['settings'] = $settings;
}
...
{
$count_11a4d82930254f841a1f88f5cc236d81 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_11a4d82930254f841a1f88f5cc236d81]['comments'] = $comments;
$this->functionData['commentsList'][$count_11a4d82930254f841a1f88f5cc236d81]['settings'] = $settings;
$this->functionData['commentsList'][$count_11a4d82930254f841a1f88f5cc236d81]['pages'] = $pages;
$this->functionData['commentsList'][$count_11a4d82930254f841a1f88f5cc236d81]['parent'] = $parent;
$this->functionData['commentsList'][$count_11a4d82930254f841a1f88f5cc236d81]['preReply'] = $preReply;
}
...
<div class='comment_wrap' id='comment_wrap'>
	".$this->__f__0be5d11a32fbb4b7f6c2e0adc36080cb($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($parent['_canComment']) ? ("
...
function __f__0be5d11a32fbb4b7f6c2e0adc36080cb($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a3336779fee115ce7c946312daeea9c1 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_a3336779fee115ce7c946312daeea9c1]['comment'] = $comment;
$this->functionData['form'][$count_a3336779fee115ce7c946312daeea9c1]['parent'] = $parent;
$this->functionData['form'][$count_a3336779fee115ce7c946312daeea9c1]['editor'] = $editor;
$this->functionData['form'][$count_a3336779fee115ce7c946312daeea9c1]['settings'] = $settings;
$this->functionData['form'][$count_a3336779fee115ce7c946312daeea9c1]['errors'] = $errors;
$this->functionData['form'][$count_a3336779fee115ce7c946312daeea9c1]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
