...
$this->_funcHooks['sendReplyForm'] = array('replyerrors','replyForm','previewPm','formHeaderText','formErrors','attachmentForm','replyOptions','replyForm','replyForm','formErrors','formHeaderText','replyOptions');
$this->_funcHooks['showConversation'] = array('hasAuthorId','authorOnline','accessModCP','authorPrivateIp','authorIpAddress','viewSigs','quickReply','reportPm','canEdit','canDelete','replies','disablelightbox','canReplyEditor','allAlone','reportPm','canEdit','canDelete','quickReply','replies','canReplyEditor','quickReply','canEdit','canDelete','replies','canReply','allAlone','canReply','allAlone2');
$this->_funcHooks['showConversationForArchive'] = array('replies','replies');
$this->_funcHooks['showFolder'] = array('folderLastPage','messagePages','hasStarterPhoto','folderNotifications','folderDrafts','folderNotificationsIgnore','folderStarter','folderToMember','folderFixPlural','folderMultipleUsers','folderNew','folderPages','folderBannedIndicator','hasPosterPhoto','folderToMember','folderBannedUser','folderMessages','folderNotDrafts','folderMessages','folderMultiOptions','folderJumpHtml','messages','folderUnread','folderDeleted','folderDrafts','folderStarter','folderToMember','folderFixPlural','folderMultipleUsers','folderBannedIndicator','folderMessages','folderMessages');
...
{
$count_48d6a664572b13b1ac45eb0c9f62df0b = is_array($this->functionData['messengerDisabled']) ? count($this->functionData['messengerDisabled']) : 0;
}
...
{
$count_a0ddc20625ed494a08a818e907ddf9d7 = is_array($this->functionData['messengerTemplate']) ? count($this->functionData['messengerTemplate']) : 0;
$this->functionData['messengerTemplate'][$count_a0ddc20625ed494a08a818e907ddf9d7]['html'] = $html;
$this->functionData['messengerTemplate'][$count_a0ddc20625ed494a08a818e907ddf9d7]['jumpmenu'] = $jumpmenu;
$this->functionData['messengerTemplate'][$count_a0ddc20625ed494a08a818e907ddf9d7]['dirData'] = $dirData;
$this->functionData['messengerTemplate'][$count_a0ddc20625ed494a08a818e907ddf9d7]['totalData'] = $totalData;
$this->functionData['messengerTemplate'][$count_a0ddc20625ed494a08a818e907ddf9d7]['topicParticipants'] = $topicParticipants;
$this->functionData['messengerTemplate'][$count_a0ddc20625ed494a08a818e907ddf9d7]['inlineError'] = $inlineError;
$this->functionData['messengerTemplate'][$count_a0ddc20625ed494a08a818e907ddf9d7]['deletedTopic'] = $deletedTopic;
}
$IPBHTML .= "<div class='master_list'>
	...
	" . ((is_array( $topicParticipants ) and count( $topicParticipants )) ? ("
		...
		".$this->__f__c6e8b77d0af18506f8910ae9027703c6($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."	") : ("")) . "				
	...
	" . (($this->settings['_hideFolders'] != 1) ? ("<h3>{$this->lang->words['folders']} " . (($this->memberData['g_max_messages'] > 0) ? ("<span class='subtext'>{$totalData['full_percent']}% {$this->lang->words['full']}</span>") : ("")) . "</h3>
		...
		" . ((count($dirData)) ? ("
			".$this->__f__610f1b6cb62704fef88518432606b694($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."		") : ("")) . "") : ("")) . "
</div>";
return $IPBHTML;
}


function __f__c6e8b77d0af18506f8910ae9027703c6($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__610f1b6cb62704fef88518432606b694($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_829e7d9a415d010eb679f7e555d132db = is_array($this->functionData['sendNewPersonalTopicForm']) ? count($this->functionData['sendNewPersonalTopicForm']) : 0;
$this->functionData['sendNewPersonalTopicForm'][$count_829e7d9a415d010eb679f7e555d132db]['displayData'] = $displayData;
}
...
{
$count_f1d65406a2ef66d638632ca7376e7ecc = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_f1d65406a2ef66d638632ca7376e7ecc]['displayData'] = $displayData;
}
$IPBHTML .= "" . (($this->settings['_hideFolders'] = 1) ? ("") : ("")) . "
...
{
$count_b265dbfcb6bd2b5a63be0da3ce6cc11d = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_b265dbfcb6bd2b5a63be0da3ce6cc11d]['topic'] = $topic;
$this->functionData['showConversation'][$count_b265dbfcb6bd2b5a63be0da3ce6cc11d]['replies'] = $replies;
$this->functionData['showConversation'][$count_b265dbfcb6bd2b5a63be0da3ce6cc11d]['members'] = $members;
$this->functionData['showConversation'][$count_b265dbfcb6bd2b5a63be0da3ce6cc11d]['jump'] = $jump;
}
$IPBHTML .= "<div class='controls'>
	...
	{$topic['_pages']}
</div>".$this->__f__492bd3802eb35288affcd7016a75659d($topic,$replies,$members,$jump)."<div class='controls'>
	<div class='buttons'>
...
function __f__492bd3802eb35288affcd7016a75659d($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cd7877253e168df4fc7d4b5ba44390c0 = is_array($this->functionData['showConversationForArchive']) ? count($this->functionData['showConversationForArchive']) : 0;
$this->functionData['showConversationForArchive'][$count_cd7877253e168df4fc7d4b5ba44390c0]['topic'] = $topic;
$this->functionData['showConversationForArchive'][$count_cd7877253e168df4fc7d4b5ba44390c0]['replies'] = $replies;
$this->functionData['showConversationForArchive'][$count_cd7877253e168df4fc7d4b5ba44390c0]['members'] = $members;
}
...
$IPBHTML .= "<html>
	...
	<body>
		...
		<br />
		<br />
		".$this->__f__dcabc0f0653546d375c908a960a13aeb($topic,$replies,$members)."	</body>
</html>";
return $IPBHTML;
}


function __f__dcabc0f0653546d375c908a960a13aeb($topic, $replies, $members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $replies as $msg_id => $msg )
...
{
$count_f35990091a1125865ed56d07a9ffa9a7 = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_f35990091a1125865ed56d07a9ffa9a7]['messages'] = $messages;
$this->functionData['showFolder'][$count_f35990091a1125865ed56d07a9ffa9a7]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_f35990091a1125865ed56d07a9ffa9a7]['pages'] = $pages;
$this->functionData['showFolder'][$count_f35990091a1125865ed56d07a9ffa9a7]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_f35990091a1125865ed56d07a9ffa9a7]['jumpFolderHTML'] = $jumpFolderHTML;
}
...
" . ((count( $messages )) ? ("
		".$this->__f__46efb2548a5956cf098e5c0a24832fa2($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."") : ("
...
function __f__46efb2548a5956cf098e5c0a24832fa2($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1268ebd52adf45f2f6f7b666d56988ff = is_array($this->functionData['showSearchResults']) ? count($this->functionData['showSearchResults']) : 0;
$this->functionData['showSearchResults'][$count_1268ebd52adf45f2f6f7b666d56988ff]['messages'] = $messages;
$this->functionData['showSearchResults'][$count_1268ebd52adf45f2f6f7b666d56988ff]['pages'] = $pages;
$this->functionData['showSearchResults'][$count_1268ebd52adf45f2f6f7b666d56988ff]['error'] = $error;
}
...
<div id='message_list'>
		<table class='ipb_table' id='message_table'>
			...
			" . ((count( $messages )) ? ("
								".$this->__f__56dcafdcd4441ad804d050b49486de7c($messages,$pages,$error)."			") : ("
				<tr>
...
function __f__56dcafdcd4441ad804d050b49486de7c($messages, $pages, $error)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $messages as $id => $msg )
