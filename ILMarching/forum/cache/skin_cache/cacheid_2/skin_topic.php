...
$this->_funcHooks['post'] = array('sDeleted','isSolvedCss','postQueued','noRep','posRep','negRep','repIgnored','userIgnoredLang','userIgnoredLangTwo','userIgnored','isNotIgnoring','postMid','hasPages','postModSelected','postModCheckbox','postMember','accessModCP','postAdmin','postIp','isSolvedSausage','repHighlight','postEditByReason','postEditBy','repButtonsLike','postSignature','canDelete','approveUnapprove','canEdit','controlsForUnapprovedPost','hideNormalControlsForUnapprovedPost','canUnanswer','notAnswered','isAnswered','canAnswerTopic','multiquote','replyButton','replyButtonWarn','canDelete','canHide','canEdit','postIsReported','canReportPost','reportedPostData','sDeletedNot','initIgnoredPost','adCodeCheck','sDeletedNotMQ','repButtonsLike','canReportPost','canEdit','canDelete','replyButton','canHide','isSolvedCss','isSolvedSausage','postMember','userIgnoredLang','userIgnoredLangTwo','postEditByReason','postEditBy','userIgnored','canEdit','canDelete','deleted','sDeleted');
...
{
$count_998c485e73c90c972fced414ce4c3555 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_998c485e73c90c972fced414ce4c3555]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_998c485e73c90c972fced414ce4c3555]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_998c485e73c90c972fced414ce4c3555]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_998c485e73c90c972fced414ce4c3555]['sharelinks'] = $sharelinks;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_916552ab04d6581777d7a47a3ed912e4 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_916552ab04d6581777d7a47a3ed912e4]['announce'] = $announce;
$this->functionData['announcement_show'][$count_916552ab04d6581777d7a47a3ed912e4]['author'] = $author;
}
...
{
$count_dda30a845aee4c021eca32e0e1e76439 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_dda30a845aee4c021eca32e0e1e76439]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_dda30a845aee4c021eca32e0e1e76439]['forum'] = $forum;
}
...
{
$count_0c9b3315636882a20e2cd704813ad92f = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_95085f4c7a7dc13e971d7863c955f0eb = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_95085f4c7a7dc13e971d7863c955f0eb]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_95085f4c7a7dc13e971d7863c955f0eb]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_95085f4c7a7dc13e971d7863c955f0eb]['opts'] = $opts;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_4ff561991e6becfe6d6a1fd098abfd60 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_4ff561991e6becfe6d6a1fd098abfd60]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_4ff561991e6becfe6d6a1fd098abfd60]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_4ff561991e6becfe6d6a1fd098abfd60]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_4ff561991e6becfe6d6a1fd098abfd60]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_4ff561991e6becfe6d6a1fd098abfd60]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_4ff561991e6becfe6d6a1fd098abfd60]['editPoll'] = $editPoll;
}
$IPBHTML .= "<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__56f426954ae97b14ccd283bbbbeff04b($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__df95553b9af5c4384ad29697bbe4d537($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__56f426954ae97b14ccd283bbbbeff04b($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__df95553b9af5c4384ad29697bbe4d537($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_9ec419fe8147cf5ffd8367245a52e8dc = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_9ec419fe8147cf5ffd8367245a52e8dc]['post'] = $post;
$this->functionData['post'][$count_9ec419fe8147cf5ffd8367245a52e8dc]['displayData'] = $displayData;
$this->functionData['post'][$count_9ec419fe8147cf5ffd8367245a52e8dc]['topic'] = $topic;
$this->functionData['post'][$count_9ec419fe8147cf5ffd8367245a52e8dc]['forum'] = $forum;
}
...
{
$count_6497862f35c383a88fa72f7164bf3355 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_6497862f35c383a88fa72f7164bf3355]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_afe2ea365a3ecdc264c61aa195cc6ec8 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_afe2ea365a3ecdc264c61aa195cc6ec8]['title'] = $title;
$this->functionData['show_attachment_title'][$count_afe2ea365a3ecdc264c61aa195cc6ec8]['data'] = $data;
$this->functionData['show_attachment_title'][$count_afe2ea365a3ecdc264c61aa195cc6ec8]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__d8575fa8870097faecfcc7542d735c73($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__d8575fa8870097faecfcc7542d735c73($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2deee0d4e328a2a4eec5280a794b752c = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_2deee0d4e328a2a4eec5280a794b752c]['data'] = $data;
}
...
{
$count_082e0b191999e9d5781d40abfadcc681 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_082e0b191999e9d5781d40abfadcc681]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_082e0b191999e9d5781d40abfadcc681]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_082e0b191999e9d5781d40abfadcc681]['topic'] = $topic;
}
...
{
$count_30a4eecee0f06553326f360d84fbe678 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_30a4eecee0f06553326f360d84fbe678]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_30a4eecee0f06553326f360d84fbe678]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_30a4eecee0f06553326f360d84fbe678]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_30a4eecee0f06553326f360d84fbe678]['displayData'] = $displayData;
}
...
<div class='master_list'>
	...
	" . ((is_array( $post_data ) AND count( $post_data )) ? ("
		".$this->__f__e84ff34dac1cda7fd0a5bc1e76e9f1ef($forum,$topic,$post_data,$displayData)."	") : ("")) . "
	...
	") : ("")) . "
		...
		<div style='text-align:center'>
			...
			<div id='mobileModOptions' style='display:none'>
				".$this->__f__7ef105ba3b732d05ace5c06db79bbae6($forum,$topic,$post_data,$displayData)."			</div>
		</div>
	") : ("")) . "
	<div class='controls'>
		<div class='buttons'>
...
function __f__e84ff34dac1cda7fd0a5bc1e76e9f1ef($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7ef105ba3b732d05ace5c06db79bbae6($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
