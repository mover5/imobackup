...
{
$count_9b5ce872c833a4981c7c44ee5ce35863 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_9b5ce872c833a4981c7c44ee5ce35863]['r'] = $r;
$this->functionData['comment'][$count_9b5ce872c833a4981c7c44ee5ce35863]['parent'] = $parent;
$this->functionData['comment'][$count_9b5ce872c833a4981c7c44ee5ce35863]['settings'] = $settings;
}
...
{
$count_afb312313b6ab30e64b2f2ecbbda8560 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_afb312313b6ab30e64b2f2ecbbda8560]['r'] = $r;
$this->functionData['commentHidden'][$count_afb312313b6ab30e64b2f2ecbbda8560]['parent'] = $parent;
$this->functionData['commentHidden'][$count_afb312313b6ab30e64b2f2ecbbda8560]['settings'] = $settings;
}
...
{
$count_0ac46bbfbab17f1b58d953f0ddf7fd73 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_0ac46bbfbab17f1b58d953f0ddf7fd73]['comments'] = $comments;
$this->functionData['commentsList'][$count_0ac46bbfbab17f1b58d953f0ddf7fd73]['settings'] = $settings;
$this->functionData['commentsList'][$count_0ac46bbfbab17f1b58d953f0ddf7fd73]['pages'] = $pages;
$this->functionData['commentsList'][$count_0ac46bbfbab17f1b58d953f0ddf7fd73]['parent'] = $parent;
$this->functionData['commentsList'][$count_0ac46bbfbab17f1b58d953f0ddf7fd73]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__8a84afd21cf4d7a85ce9b9d2fb7e7a88($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__8a84afd21cf4d7a85ce9b9d2fb7e7a88($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5a142961c01a3605061df0ff74c01056 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_5a142961c01a3605061df0ff74c01056]['comment'] = $comment;
$this->functionData['form'][$count_5a142961c01a3605061df0ff74c01056]['parent'] = $parent;
$this->functionData['form'][$count_5a142961c01a3605061df0ff74c01056]['editor'] = $editor;
$this->functionData['form'][$count_5a142961c01a3605061df0ff74c01056]['settings'] = $settings;
$this->functionData['form'][$count_5a142961c01a3605061df0ff74c01056]['errors'] = $errors;
$this->functionData['form'][$count_5a142961c01a3605061df0ff74c01056]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
