...
{
$count_e74ecee4b22d91a451edbf76865597d5 = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_e74ecee4b22d91a451edbf76865597d5]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_e74ecee4b22d91a451edbf76865597d5]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_e74ecee4b22d91a451edbf76865597d5]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_e74ecee4b22d91a451edbf76865597d5]['extraData'] = $extraData;
}
...
{
$count_431498d168d21c6779686276c245ef73 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_431498d168d21c6779686276c245ef73]['formField'] = $formField;
$this->functionData['editor'][$count_431498d168d21c6779686276c245ef73]['content'] = $content;
$this->functionData['editor'][$count_431498d168d21c6779686276c245ef73]['options'] = $options;
$this->functionData['editor'][$count_431498d168d21c6779686276c245ef73]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_431498d168d21c6779686276c245ef73]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_431498d168d21c6779686276c245ef73]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_431498d168d21c6779686276c245ef73]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_431498d168d21c6779686276c245ef73]['showEditor'] = $showEditor;
}
...
{
$count_64a28b4ae5070132d6f2854bca39c288 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_64a28b4ae5070132d6f2854bca39c288]['options'] = $options;
$this->functionData['editorLoadJs'][$count_64a28b4ae5070132d6f2854bca39c288]['inlineLoad'] = $inlineLoad;
}
...
{
$count_aa314b4d301d40a31a04a587d99d5f64 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_aa314b4d301d40a31a04a587d99d5f64]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_aa314b4d301d40a31a04a587d99d5f64]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_aa314b4d301d40a31a04a587d99d5f64]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_aa314b4d301d40a31a04a587d99d5f64]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__9f77bf857badfd8e22715adfe365f667($rows,$pages,$app,$plugin)."		") : ("
...
function __f__9f77bf857badfd8e22715adfe365f667($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_5f35364d9ebf5fbd9e5abd84dcb8cd4b = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_5f35364d9ebf5fbd9e5abd84dcb8cd4b]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__f11f615c9f76d11daf98f07bb175b0fd($tabs)."			</ul>
		</div>
...
function __f__f11f615c9f76d11daf98f07bb175b0fd($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
