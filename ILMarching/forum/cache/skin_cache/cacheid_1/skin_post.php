...
{
$count_7028261f3bc037e2f39818c9fda852a7 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_7028261f3bc037e2f39818c9fda852a7]['data'] = $data;
}
...
{
$count_6963999aab3557d6f52fdf327fa03e8f = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_6963999aab3557d6f52fdf327fa03e8f]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_6963999aab3557d6f52fdf327fa03e8f]['form'] = $form;
}
...
{
$count_47e73ba3592b3b444a268d906a961dcc = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_47e73ba3592b3b444a268d906a961dcc]['data'] = $data;
}
...
{
$count_9857cda1df1c070564fbd36ad69cef5a = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_9857cda1df1c070564fbd36ad69cef5a]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__350fedb4662548c19e1467ddc0bd37af($posts)."") : ("")) . "
<p class='submit'>
...
function __f__350fedb4662548c19e1467ddc0bd37af($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_96ac2b8727ad8fa14a1b72a4fe8e81db = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_96ac2b8727ad8fa14a1b72a4fe8e81db]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_96ac2b8727ad8fa14a1b72a4fe8e81db]['type'] = $type;
$this->functionData['uploadForm'][$count_96ac2b8727ad8fa14a1b72a4fe8e81db]['stats'] = $stats;
$this->functionData['uploadForm'][$count_96ac2b8727ad8fa14a1b72a4fe8e81db]['id'] = $id;
$this->functionData['uploadForm'][$count_96ac2b8727ad8fa14a1b72a4fe8e81db]['forum_id'] = $forum_id;
}
