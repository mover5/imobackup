...
{
$count_13252e68e51b8e1d3758556742af1b48 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_13252e68e51b8e1d3758556742af1b48]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_13252e68e51b8e1d3758556742af1b48]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_13252e68e51b8e1d3758556742af1b48]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_13252e68e51b8e1d3758556742af1b48]['sharelinks'] = $sharelinks;
}
...
{
$count_829316f5bb3e70f278c49c60971a5501 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_829316f5bb3e70f278c49c60971a5501]['announce'] = $announce;
$this->functionData['announcement_show'][$count_829316f5bb3e70f278c49c60971a5501]['author'] = $author;
}
...
{
$count_388bc3c30378a673bb91428a4601759c = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_388bc3c30378a673bb91428a4601759c]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_388bc3c30378a673bb91428a4601759c]['forum'] = $forum;
}
...
{
$count_442eeb75d5753771040454a58ea5a2f0 = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_3e68c1d13daf03c8126350f537cfa42c = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_3e68c1d13daf03c8126350f537cfa42c]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_3e68c1d13daf03c8126350f537cfa42c]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_3e68c1d13daf03c8126350f537cfa42c]['opts'] = $opts;
}
...
{
$count_1998544b59c211b11bd55e6a5f408296 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_1998544b59c211b11bd55e6a5f408296]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_1998544b59c211b11bd55e6a5f408296]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_1998544b59c211b11bd55e6a5f408296]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_1998544b59c211b11bd55e6a5f408296]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_1998544b59c211b11bd55e6a5f408296]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_1998544b59c211b11bd55e6a5f408296]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__840f3a85926ec17bb2daf3cd0eb2b5bb($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__849bb0121862188f237b2abc92e2bf79($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__51adc1c36d4913dc4ab4f9ee8845fb51($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__849bb0121862188f237b2abc92e2bf79($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__840f3a85926ec17bb2daf3cd0eb2b5bb($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__51adc1c36d4913dc4ab4f9ee8845fb51($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_46be05dc67c68c3ab668d21cfc66f49f = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_46be05dc67c68c3ab668d21cfc66f49f]['post'] = $post;
$this->functionData['post'][$count_46be05dc67c68c3ab668d21cfc66f49f]['displayData'] = $displayData;
$this->functionData['post'][$count_46be05dc67c68c3ab668d21cfc66f49f]['topic'] = $topic;
$this->functionData['post'][$count_46be05dc67c68c3ab668d21cfc66f49f]['forum'] = $forum;
}
...
{
$count_46a24a875f1f373014cdeb88213c3875 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_46a24a875f1f373014cdeb88213c3875]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_9e2cff1c52a09bc326c38b66f873f3d6 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_9e2cff1c52a09bc326c38b66f873f3d6]['title'] = $title;
$this->functionData['show_attachment_title'][$count_9e2cff1c52a09bc326c38b66f873f3d6]['data'] = $data;
$this->functionData['show_attachment_title'][$count_9e2cff1c52a09bc326c38b66f873f3d6]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__e86b94e48cb3ee7857259946da4b1d09($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__e86b94e48cb3ee7857259946da4b1d09($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ce5e5e4d5c72fd75bbe321b3399e531d = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_ce5e5e4d5c72fd75bbe321b3399e531d]['data'] = $data;
}
...
{
$count_ce8b7f7462faedc19f8d2d5216d6991a = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_ce8b7f7462faedc19f8d2d5216d6991a]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_ce8b7f7462faedc19f8d2d5216d6991a]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_ce8b7f7462faedc19f8d2d5216d6991a]['topic'] = $topic;
}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__52f11b644e35a5d4e46e1a800adcd028($topic,$posts)."<br class='clear' />
...
function __f__52f11b644e35a5d4e46e1a800adcd028($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4d784fa5b11f43a236a91c44e7dd5d2d = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_4d784fa5b11f43a236a91c44e7dd5d2d]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_4d784fa5b11f43a236a91c44e7dd5d2d]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_4d784fa5b11f43a236a91c44e7dd5d2d]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_4d784fa5b11f43a236a91c44e7dd5d2d]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__18a94633fed3d4bb1da4bb2e71c04283($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__79a6c5c4566d4523dfd640471368fceb($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__ed7e5e566e71854d1b6dbf13d74c011a($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__e44e8d3e21b620c2555eac2152f56617($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__6bd687b4435ccb0a774d95099654c295($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__18a94633fed3d4bb1da4bb2e71c04283($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__79a6c5c4566d4523dfd640471368fceb($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ed7e5e566e71854d1b6dbf13d74c011a($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e44e8d3e21b620c2555eac2152f56617($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6bd687b4435ccb0a774d95099654c295($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
