...
/* CACHE FILE: Generated: Tue, 28 Jan 2014 19:29:19 GMT */
...
{
$count_837c62668c897177ee8bb37448efee79 = is_array($this->functionData['coreAttachments']) ? count($this->functionData['coreAttachments']) : 0;
$this->functionData['coreAttachments'][$count_837c62668c897177ee8bb37448efee79]['info'] = $info;
$this->functionData['coreAttachments'][$count_837c62668c897177ee8bb37448efee79]['pages'] = $pages;
$this->functionData['coreAttachments'][$count_837c62668c897177ee8bb37448efee79]['attachments'] = $attachments;
}
...
<div class='row1'>	
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		<tr class='header'>
			...
			" . ((count($attachments)) ? ("
								".$this->__f__98b38162850538f427db325e62f8d33c($info,$pages,$attachments)."			") : ("
				<tr>
...
function __f__98b38162850538f427db325e62f8d33c($info="",$pages="",$attachments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1a55b58b0027760fb9597b01ba2b3c03 = is_array($this->functionData['displayNameForm']) ? count($this->functionData['displayNameForm']) : 0;
$this->functionData['displayNameForm'][$count_1a55b58b0027760fb9597b01ba2b3c03]['form'] = $form;
$this->functionData['displayNameForm'][$count_1a55b58b0027760fb9597b01ba2b3c03]['error'] = $error;
$this->functionData['displayNameForm'][$count_1a55b58b0027760fb9597b01ba2b3c03]['okmessage'] = $okmessage;
$this->functionData['displayNameForm'][$count_1a55b58b0027760fb9597b01ba2b3c03]['isFB'] = $isFB;
}
$IPBHTML .= "" . (($okmessage != "") ? ("
...
{
$count_1f0fd4875783879eae275dc3aa506a01 = is_array($this->functionData['emailPasswordChangeForm']) ? count($this->functionData['emailPasswordChangeForm']) : 0;
$this->functionData['emailPasswordChangeForm'][$count_1f0fd4875783879eae275dc3aa506a01]['txt'] = $txt;
$this->functionData['emailPasswordChangeForm'][$count_1f0fd4875783879eae275dc3aa506a01]['_message'] = $_message;
$this->functionData['emailPasswordChangeForm'][$count_1f0fd4875783879eae275dc3aa506a01]['isFB'] = $isFB;
}
...
{
$count_3b8d2b6815c3540162bd80177072a8e2 = is_array($this->functionData['field_entry']) ? count($this->functionData['field_entry']) : 0;
$this->functionData['field_entry'][$count_3b8d2b6815c3540162bd80177072a8e2]['title'] = $title;
$this->functionData['field_entry'][$count_3b8d2b6815c3540162bd80177072a8e2]['desc'] = $desc;
$this->functionData['field_entry'][$count_3b8d2b6815c3540162bd80177072a8e2]['content'] = $content;
$this->functionData['field_entry'][$count_3b8d2b6815c3540162bd80177072a8e2]['id'] = $id;
}
...
{
$count_c9b1501929ea6070c0b5f138d7d0f7c0 = is_array($this->functionData['membersFacebookConnect']) ? count($this->functionData['membersFacebookConnect']) : 0;
$this->functionData['membersFacebookConnect'][$count_c9b1501929ea6070c0b5f138d7d0f7c0]['fbuid'] = $fbuid;
$this->functionData['membersFacebookConnect'][$count_c9b1501929ea6070c0b5f138d7d0f7c0]['fbUserData'] = $fbUserData;
$this->functionData['membersFacebookConnect'][$count_c9b1501929ea6070c0b5f138d7d0f7c0]['linkedMemberData'] = $linkedMemberData;
$this->functionData['membersFacebookConnect'][$count_c9b1501929ea6070c0b5f138d7d0f7c0]['perms'] = $perms;
}
...
{
$count_ce8e1133e782cd5dc0fb773a04ebac80 = is_array($this->functionData['membersIgnoredUsersForm']) ? count($this->functionData['membersIgnoredUsersForm']) : 0;
$this->functionData['membersIgnoredUsersForm'][$count_ce8e1133e782cd5dc0fb773a04ebac80]['members'] = $members;
$this->functionData['membersIgnoredUsersForm'][$count_ce8e1133e782cd5dc0fb773a04ebac80]['pagination'] = $pagination;
}
...
<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
	<tr class='header'>
		...
		" . ((count( $members )) ? ("".$this->__f__44ee7d2adfaf135694e973390c08c466($members,$pagination)."	") : ("<tr>
...
function __f__44ee7d2adfaf135694e973390c08c466($members, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b9d0c5d3eb855351a89f501cc491868f($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__55013cc17dd0fe99d8fc4ee5c67335ac($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mon as $m )
...
function __f__1822e89635ded337a3d3076228f2dbaf($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day as $d )
...
function __f__f84eeae15c4a7ebe2dc071fcc26ae6e3($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $year as $y )
...
function __f__739d1cbbea226b3a89113d4776ba737a($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array(),$cgroup='',$cfields='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3235dcd35c7da59bcefe9c33223642a5($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . ((count( $cfields )) ? ("
				<fieldset class='ipsSettings_section'>
					...
					<div>
						<ul>
							".$this->__f__739d1cbbea226b3a89113d4776ba737a($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times,$cgroup,$cfields)."						</ul>
					</div>
				</fieldset>
			") : ("")) . "
...
{
$count_5631719269bb55816f2ef32119a6ed10 = is_array($this->functionData['membersSignatureForm']) ? count($this->functionData['membersSignatureForm']) : 0;
$this->functionData['membersSignatureForm'][$count_5631719269bb55816f2ef32119a6ed10]['editor_html'] = $editor_html;
$this->functionData['membersSignatureForm'][$count_5631719269bb55816f2ef32119a6ed10]['sig_restrictions'] = $sig_restrictions;
$this->functionData['membersSignatureForm'][$count_5631719269bb55816f2ef32119a6ed10]['signature'] = $signature;
}
...
{
$count_114d3d12bbb68217a89ff1a65172d2ac = is_array($this->functionData['membersTwitterConnect']) ? count($this->functionData['membersTwitterConnect']) : 0;
$this->functionData['membersTwitterConnect'][$count_114d3d12bbb68217a89ff1a65172d2ac]['isConnected'] = $isConnected;
$this->functionData['membersTwitterConnect'][$count_114d3d12bbb68217a89ff1a65172d2ac]['twitterUser'] = $twitterUser;
}
...
{
$count_0105009009456f7d612d864c270a0cc1 = is_array($this->functionData['notificationsForm']) ? count($this->functionData['notificationsForm']) : 0;
$this->functionData['notificationsForm'][$count_0105009009456f7d612d864c270a0cc1]['config'] = $config;
$this->functionData['notificationsForm'][$count_0105009009456f7d612d864c270a0cc1]['emailData'] = $emailData;
}
...
<fieldset class='row1'>
	<span class='desc'><strong>{$this->lang->words['notifications_info_acp']}</strong></span>
		...
		".$this->__f__afeb777d07cd2c1f011f9b2ed4c6bdb7($config,$emailData)."		".$this->__f__7a6bb064c6424d6330490857b288c105($config,$emailData)."	</table>
</fieldset>";
return $IPBHTML;
}


function __f__2e9ace8943676cbb8d86c8c664d10cc8($config, $emailData,$groupKey='',$group='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__afeb777d07cd2c1f011f9b2ed4c6bdb7($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->notifyGroups as $groupKey => $group )
	{
		...
		$_ips___x_retval .= "
			...
			".$this->__f__2e9ace8943676cbb8d86c8c664d10cc8($config,$emailData,$groupKey,$group)."							
...
function __f__7a6bb064c6424d6330490857b288c105($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a2b3c5f37fd2a3f8895a0451bc690557 = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_a2b3c5f37fd2a3f8895a0451bc690557]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_a2b3c5f37fd2a3f8895a0451bc690557]['error'] = $error;
$this->functionData['notificationsLog'][$count_a2b3c5f37fd2a3f8895a0451bc690557]['pages'] = $pages;
}
		...
		<table class='ipb_table' summary=\"{$this->lang->words['notifications_table_head']}\">
			<tr class='header hide'>
				...
				<th scope='col' align=\"center\" width=\"5%\" class='short'>&nbsp;</th>
						...
						".$this->__f__f8d186d60f5e4057ba25912f3dcd1cee($notifications,$error,$pages)."		</table>
		<script type='text/javascript'>
...
function __f__f8d186d60f5e4057ba25912f3dcd1cee($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c203fd4de75748095cddaea1e2edbc23 = is_array($this->functionData['userCPTemplate']) ? count($this->functionData['userCPTemplate']) : 0;
$this->functionData['userCPTemplate'][$count_c203fd4de75748095cddaea1e2edbc23]['current_tab'] = $current_tab;
$this->functionData['userCPTemplate'][$count_c203fd4de75748095cddaea1e2edbc23]['html'] = $html;
$this->functionData['userCPTemplate'][$count_c203fd4de75748095cddaea1e2edbc23]['tabs'] = $tabs;
$this->functionData['userCPTemplate'][$count_c203fd4de75748095cddaea1e2edbc23]['current_area'] = $current_area;
$this->functionData['userCPTemplate'][$count_c203fd4de75748095cddaea1e2edbc23]['errors'] = $errors;
$this->functionData['userCPTemplate'][$count_c203fd4de75748095cddaea1e2edbc23]['hide_form'] = $hide_form;
$this->functionData['userCPTemplate'][$count_c203fd4de75748095cddaea1e2edbc23]['maxUpload'] = $maxUpload;
}
...
" . ((count($tabs) > 1) ? ("
	<div class='maintitle ipsFilterbar clearfix'>
		<ul class='ipsList_inline'>
			".$this->__f__b1d2cc632a9546913dc9e3d9b1f0259a($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."		</ul>
	</div>
") : ("")) . "
<div class='ipsBox'>
	<div class='ipsLayout" . (($hasMoreTabs) ? (" ipsLayout_withleft ipsLayout_smallleft ipsVerticalTabbed") : ("")) . " clearfix usercp_body'>
		" . (($hasMoreTabs) ? ("
			<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='usercp_tabs'>
				<ul>
					".$this->__f__a3533c97fabd0f4b1ff05373ce641675($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."				</ul>
			</div>
		") : ("")) . "
		<div class='" . (($hasMoreTabs) ? ("ipsVerticalTabbed_content ") : ("")) . "ipsLayout_content ipsBox_container' id='usercp_content'>
			<div class='ipsPad'>
				" . ((is_array( $errors ) AND count( $errors )) ? ("
					<p class='message error'>
						".$this->__f__34328057303dcdbdec6def0532b5acff($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."					</p>
					<br />
				") : ("")) . "
...
function __f__b1d2cc632a9546913dc9e3d9b1f0259a($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a3533c97fabd0f4b1ff05373ce641675($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__34328057303dcdbdec6def0532b5acff($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
